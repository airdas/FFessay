...
\usepackage[hmarginratio=1:1,top=15mm, bottom=15mm, left=20mm, right=20mm,columnsep=20pt]{geometry} % Document margins
%\usepackage{anysize}
...
The structure of this review is as follows: in section~\ref{sec:Problems}, the predicted difficulties for operation of ITER as a result of ELMs are discussed. In section~\ref{sec:Control}, methods for ELM suppression and mitigation are summarised (specifically resonant magnetic perturbations, pellet injection and vertical kicks) and comments are made regarding their implementation and effectiveness on ITER. Finally section~\ref{sec:Future} includes suggestions for further work required in order to operate ITER in ELM suppressed or mitigated scenarios.
...
\begin{figure}
\includegraphics[scale=0.35]{Figures/PI_ELMprob.png}
\centering
...
\begin{figure}
\includegraphics[scale=0.35]{Figures/VKELMprob.png}
\centering
...
\section{Conclusion}
To summarise, the ELM suppression and mitigation techniques discussed in this paper require further investigation before they can be reliably implemented on ITER. The 
