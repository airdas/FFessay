...
\usepackage[url=false, maxcitenames=3]{apsrev4-1}
...
\author{Joe Allen}
\email{joa509@york.ac.uk}
\affiliation{York Plasma Institute, University of York, YO10 5DD
York, United Kingdom}
...
\bibliography{BIB_FFreview2} % Tell bibtex which .bib file to use (e.g. revtex_example.bib)
